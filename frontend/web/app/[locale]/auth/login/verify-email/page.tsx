...
import { sendEmailSchema } from '../login/utils/schemas/login.schema';
...
const translations = {
  en: {
    ...
    loginSubtitle: 'Sign in to your Lead Manager  account',
    email: 'Email',
    password: 'Password',
    forgotPassword: 'Forgot your password?',
    signIn: 'Send Link To E-mail',
    dontHaveAccount: "Don't have an account?",
    signUp: 'Sign up',
    emailPlaceholder: 'Enter your email',
    passwordPlaceholder: 'Enter your password',
    poweredBy: '© 2025 Lead Manager  - Remote Work Aproved, All rights reserved.',
  },
  pt: {
    welcomeBack: 'Bem-vindo de Volta',
    loginSubtitle: 'Entre na sua conta Lead Manager ',
    email: 'E-mail',
    password: 'Senha',
    forgotPassword: 'Esqueceu sua senha?',
    signIn: 'Enviar Link Para E-mail',
    dontHaveAccount: 'Não tem uma conta?',
    signUp: 'Cadastre-se',
    emailPlaceholder: 'Digite seu e-mail',
    passwordPlaceholder: 'Digite sua senha',
    poweredBy: '© 2025 Lead Manager  - Remote Work Aproved, Todos os direitos reservados.',
  },
};

export default function SendEmailPage(): ReactElement {
  ...
  const { mutateAsync: login, isPending } = api.auth.useVerifyEmail();
  ...
  const handleSubmit = async (data: z.infer<typeof sendEmailSchema>) => {
    try {
      await login(data);
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <Input
                            ...
                            className='bg-black/50 border-white/20 text-white placeholder:text-gray-400 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all duration-300 h-12'
